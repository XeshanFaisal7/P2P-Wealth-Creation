...
if(isset($_GET['id']) && isset($_GET['category']))
{
  ...
  $data_query="SELECT * FROM `health` WHERE `id`='$id' AND `category`='$category'";
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>UPDATE HEALTH INSURANCE</strong>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div id="self">
                                          <div class="row">
                                            ...
                                            <input type="date" id="self_dob" name="self_dob" value="<?php echo $row['self_dob']?>" class="form-control">
                                            <small style="color: red ; font-weight : bold" id="self_dob_error"></small> 
                                             ...
                                             <div class="col-lg-6">
                                            <div class="form-group">
                                            <label for="self_ped" value="<?php echo $row['self_ped']?>" class=" form-control-label"><b>Pre-Existing</b> </label>
                                            <input type="text" id="self_ped" value="<?php echo $row['self_ped']?>" name="self_ped" placeholder="Enter Self PED" class="form-control">
                                        ...
                                        ?>
                                         ...
                                         <div id="spouse" style="display: block">
                                          <div class="row">
                                             <div class="col-lg-6">
                                             <div class="form-group">
                                            <label for="spouse_dob" class=" form-control-label"><b>SPOUSE</b></label>
                                            <input type="date" id="spouse_dob" name="spouse_dob" value="<?php echo $row['spouse_dob']?>" class="form-control">
                                            ...
                                            <input type="text" id="spouse_ped" value="<?php echo $row['spouse_ped']?>" name="spouse_ped" placeholder="Enter Spouse PED" class="form-control">
                                         ...
                                         <div id="child_1" style="display: block">
                                          <div class="row">
                                             <div class="col-lg-6">
                                             <div class="form-group">
                                            <label for="child_1_dob"  class=" form-control-label"><b>Child 1</b></label>
                                            <input type="date" id="child_1_dob" value="<?php echo $row['child_1_dob']?>" name="child_1_dob" class="form-control">
                                            ...
                                            <input type="text" id="child_1_ped" name="child_1_ped" value="<?php echo $row['child_1_ped']?>" placeholder="Enter Child 1 PED" class="form-control">
                                        ...
                                        <div id="child_2" style="display: block">
                                          <div class="row">
                                             <div class="col-lg-6">
                                             <div class="form-group">
                                            <label for="child_2_dob" class=" form-control-label"><b>Child 2</b></label>
                                            <input type="date" value="<?php echo $row['child_2_dob']?>" id="child_2_dob" name="child_2_dob" class="form-control">
                                            ...
                                            <input type="text" id="child_2_ped" name="child_2_ped" value="<?php echo $row['child_2_ped']?>" placeholder="Enter Child 2 PED" class="form-control">
                                        ...
                                        <?php } ?>
                                         <div class="form-group">
                                            ...
                                            <option value="<?php echo $row['sum_insured']?>"><?php echo $row['sum_insured']?></option>
                                          ...
                                          <button type="submit" class="btn btn-primary" name="update_health">Update</button>
                                    </div>
                                </div>
                            </div>
