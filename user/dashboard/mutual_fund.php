                                    ...
                                    <div class="card-header">
                                        <strong>MUTUAL FUNDS</strong>
                                         ...
                                         <div class="card-body card-block">
                                            ...
                                            <input type="text" id="pan_no" name="pan_no" placeholder="Enter Pan Number" class="form-control">
                                            ...
                                            <select class="form-control" name="type_of_investment" id="type_of_investment">
                                            <option value="">Select Option</option>
                                            ...
                                            <select class="form-control" name="mode_of_investment" id="mode_of_investment">
                                            <option value="">Select Option</option>
                                           ...
                                           <br>
                                             ...
                                             <button type="submit" class="btn btn-primary" name="mutual_fund">Submit</button>
