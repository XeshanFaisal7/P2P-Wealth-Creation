<?php
include('header.php');
$active_customer="SELECT * FROM `customer` WHERE `status`='active'";
$active_result=mysqli_query($db,$active_customer);
                    ...
                    <table class="table table-hover">
                      ...
                      {  
                        ...
                        <tr>
                          ...
                          <td onclick="change_status(<?php echo $row['id']?>)"><label class="badge badge-success"><?php echo $row['status'];?></label></td>
                          <td>
