...
$pending_customer_query="SELECT * FROM `customer` WHERE `status`='pending'";
$pending_customer_result=mysqli_query($db,$pending_customer_query);
$pending_customer_total=mysqli_num_rows($pending_customer_result);


$active_customer_query="SELECT * FROM `customer` WHERE `status`='active'";
$active_customer_result=mysqli_query($db,$active_customer_query);
$active_customer_total=mysqli_num_rows($active_customer_result);

$deactive_customer_query="SELECT * FROM `customer` WHERE `status`='inactive'";
$deactive_customer_result=mysqli_query($db,$deactive_customer_query);
$deactive_customer_total=mysqli_num_rows($deactive_customer_result);

?>
  <title>P2P Wealth Creation | Admin</title>
      <!-- partial -->
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">Hi <b style="color:#3498DB "><?php echo $_SESSION['admin_name']; ?></b>, welcome back!</h4>
            ...
            <div class="col-xl-12 flex-column d-flex grid-margin stretch-card">
              <div class="row flex-grow">
                <div class="col-sm-4 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                          <h4 class="card-title">Pending Customers</h4>
                          <p>Pending customers waiting for approval</p>
                          <h4 class="text-dark font-weight-bold mb-2"><?php echo $pending_customer_total; ?></h4>
                           <div class="progress progress-md grouped mb-2">
                          <?php 
                          if($pending_customer_total==0)  
                          {
                          ?>
                          ...
                          ?>
                          <?php 
                          if($pending_customer_total>0 && $pending_customer_total<=50)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 5%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 95%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>50 && $pending_customer_total<=100)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 10%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 90%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>100 && $pending_customer_total<=150)  
                          {
                          ?>
                          ...
                          ?>
                          <?php 
                          if($pending_customer_total>150 && $pending_customer_total<=200)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 80%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>200 && $pending_customer_total<=300)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 75%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>300 && $pending_customer_total<=400)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 70%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>400 && $pending_customer_total<=500)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 40%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 60%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>

                          <?php 
                          if($pending_customer_total>500 && $pending_customer_total<=700)  
                          {
                          ?>
                          ...
                          ?>
                          <?php 
                          if($pending_customer_total>700 && $pending_customer_total<=900)  
                          {
                          ?>
                          <div class="progress-bar  bg-primary" role="progressbar" style="width: 60%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 40%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>

                          <?php 
                          if($pending_customer_total>900 && $pending_customer_total<=1200)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 70%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 30%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>1200 && $pending_customer_total<=1500)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 20%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>

                          <?php 
                          if($pending_customer_total>1500 && $pending_customer_total<=1900)  
                          {
                          ?>
                          <div class="progress-bar  bg-success" role="progressbar" style="width: 90%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 10%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                          <?php 
                          if($pending_customer_total>1900)  
                          {
                          ?>
                          <div class="progress-bar  bg-success" role="progressbar" style="width: 100%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 0%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          <?php
                          }
                          ?>
                        </div>
                ...
                <div class="col-sm-4 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                          ...
                          <p>Registered and active customers</p>
                          <h4 class="text-dark font-weight-bold mb-2"><?php echo $active_customer_total; ?></h4>
                           <div class="progress progress-md grouped mb-2">
                         <?php 
                          if($active_customer_total==0)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 100%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>0 && $active_customer_total<=50)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 5%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 95%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>50 && $active_customer_total <=100)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 10%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 90%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>100 && $active_customer_total<=150)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 15%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 85%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>150 && $active_customer_total<=200)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 80%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>200 && $active_customer_total<=300)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 75%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>300 && $active_customer_total<=400)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 70%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>400 && $active_customer_total<=500)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 40%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 60%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($active_customer_total>500 && $active_customer_total<=700)  
                          {
                          ?>
                          <div class="progress-bar  bg-primary" role="progressbar" style="width: 50%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>700 && $active_customer_total<=900)  
                          {
                          ?>
                          <div class="progress-bar  bg-primary" role="progressbar" style="width: 60%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 40%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($active_customer_total>900 && $active_customer_total<=1200)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 70%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 30%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($active_customer_total>1200 && $active_customer_total <=1500)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 20%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($active_customer_total>1500 && $active_customer_total <=1900)  
                          {
                          ?>
                          <div class="progress-bar  bg-success" role="progressbar" style="width: 90%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 10%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
               ...
               <div class="col-sm-4 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                          ...
                          <p>Registered and deactive customers </p>
                          <h4 class="text-dark font-weight-bold mb-2"><?php echo $deactive_customer_total; ?></h4>
                           <div class="progress progress-md grouped mb-2">
                          <?php 
                          if($deactive_customer_total==0)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 100%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>0 && $deactive_customer_total<=50)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 5%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 95%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>50 && $deactive_customer_total <=100)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 10%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 90%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>100 && $deactive_customer_total<=150)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 15%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 85%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>150 && $deactive_customer_total<=200)  
                          {
                          ?>
                          <div class="progress-bar  bg-danger" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 80%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>200 && $deactive_customer_total<=300)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 75%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>300 && $deactive_customer_total<=400)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 70%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>400 && $deactive_customer_total<=500)  
                          {
                          ?>
                          <div class="progress-bar  bg-info" role="progressbar" style="width: 40%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 60%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($deactive_customer_total>500 && $deactive_customer_total<=700)  
                          {
                          ?>
                          <div class="progress-bar  bg-primary" role="progressbar" style="width: 50%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>700 && $deactive_customer_total<=900)  
                          {
                          ?>
                          <div class="progress-bar  bg-primary" role="progressbar" style="width: 60%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 40%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($deactive_customer_total>900 && $deactive_customer_total<=1200)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 70%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 30%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>1200 && $deactive_customer_total <=1500)  
                          {
                          ?>
                          <div class="progress-bar  bg-warning" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 20%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          <?php 
                          if($deactive_customer_total>1500 && $deactive_customer_total <=1900)  
                          {
                          ?>
                          <div class="progress-bar  bg-success" role="progressbar" style="width: 90%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 10%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          ...
                          ?>
                          <?php 
                          if($deactive_customer_total>1900)  
                          {
                          ?>
                          <div class="progress-bar  bg-success" role="progressbar" style="width: 100%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          <div class="progress-bar bg-light" role="progressbar" style="width: 0%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
